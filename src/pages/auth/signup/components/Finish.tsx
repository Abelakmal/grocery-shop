...
const Finish = () => {
  return (
    <div className="lg:w-1/2 sm:p-10 p-4 h-full flex flex-col ">
      <div className="h-1/2 bg-green-600 w-full flex flex-col items-center justify-center rounded-t-lg">
        ...
        <p className="text-white font-semibold text-4xl">Success</p>
      </div>
      <div className="h-1/2 shadow-lg flex flex-col justify-center items-center px-4">
        <p className="text-xl text-gray-500">
          Congratulations, your account has been successfully created.
        </p>
        <Link to={"/signin"}>
          <button className="bg-green-600 text-white mt-4 p-2 rounded-lg">Continue</button>
        </Link>
      </div>
    </div>
  );
